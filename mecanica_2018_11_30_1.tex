...
\draw [->, thick, orange] (v1.center) -- (0.5,1) node [midway, above] {$\vec{q}_1$};
\draw [->, thick, blue](0,-0.5) node (v3) {} -- (0.5,1)node [midway, left] {$\vec{q}^{\,*}$};
\draw [->, thick, brown] (0.5,1) -- (1.5,-0.5) node [midway, right] {$\vec{q}_2$};
